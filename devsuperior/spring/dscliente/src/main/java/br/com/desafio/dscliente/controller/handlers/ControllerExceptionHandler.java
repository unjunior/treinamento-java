...
import br.com.desafio.dscliente.dto.ValidationError;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> recursoNaoEncontrado(ResourceNotFound e, HttpServletRequest request){
